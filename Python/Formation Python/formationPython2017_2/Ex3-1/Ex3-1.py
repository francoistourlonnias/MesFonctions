...
K_flightList = [ "departCity", "arriveCity", "departTime", "departDay",
                "arriveTime", "arriveDay", "cost", "code" ]
L_flightList= zip(K_flightList,flightList)
D_flightList=dict(L_flightList)

departCity, arriveCity, departTime, departDay, arriveTime, arriveDay, price, code = flightList

print departCity, arriveCity, departTime, departDay

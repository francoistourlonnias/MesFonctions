...
def flightsPerCities(dict,departApt,arriveApt):
    ...
    return outList
#amelioration!!!!!!          
return [code for code in dict if dict[key][0] == departApt \
            and dict[key][1] == arriveApr ]
#ou
return [code for elem in dict.items() if rlm[0] = ...]
#mais ici on oblige python a dupliquer le tableau  utiliser alors dict.iteritems() qui ne fera pas cette duplication
#ou mieux
return [code for code,data in dict.items() if data[0] == departApt ...]
# Part B
